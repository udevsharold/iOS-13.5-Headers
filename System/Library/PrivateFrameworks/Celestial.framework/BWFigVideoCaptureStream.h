...
@property (nonatomic,readonly) SCD_Struct_BW60 clientAuditToken;                                                          //@synthesize clientAuditToken=_clientAuditToken - In the implementation block
...
-(SCD_Struct_BW60)clientAuditToken;
-(BOOL)hasFocus;
...
-(id)_aeTables;
-(id)initWithFigCaptureStream:(OpaqueFigCaptureStreamRef)arg1 attributes:(id)arg2 sensorIDDictionary:(id)arg3 isSynchronizationMaster:(BOOL)arg4 synchronizedStreamsEnabled:(BOOL)arg5 cameraViewMatrix:(id)arg6 cameraPoseMatrix:(id)arg7 applicationID:(id)arg8 clientAuditToken:(SCD_Struct_BW60)arg9 baseZoomFactor:(float)arg10 error:(int*)arg11 ;
