...
typedef struct {
	...
	double field2;
	double field3;
	SCD_Struct_UI49 field4;
	SCD_Struct_UI49 field5;
	SCD_Struct_UI49 field6;
	SCD_Struct_UI49 field7;
	BOOL field8;
} SCD_Struct_UI50;
...
typedef struct {
	SCD_Struct_UI69 field1;
	SCD_Struct_UI69 field2;
	SCD_Struct_UI69 field3;
} SCD_Struct_UI70;
...
typedef union GLKVector3 {
	SCD_Struct_UI90 field1;
	SCD_Struct_UI90 field2;
	SCD_Struct_UI90 field3;
	float v[3];
} GLKVector3;
...
typedef union GLKQuaternion {
	SCD_Struct_UI92 field1;
	SCD_Struct_UI93 field2;
	float q[4];
} GLKQuaternion;
...
typedef struct {
	SCD_Struct_UI44 dampingRatioParameters;
	SCD_Struct_UI44 responseParameters;
	SCD_Struct_UI44 targetParameters;
