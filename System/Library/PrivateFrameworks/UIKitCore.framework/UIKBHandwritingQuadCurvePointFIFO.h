...
@property (assign,nonatomic) SCD_Struct_UI83 lastPoint;                //@synthesize lastPoint=_lastPoint - In the implementation block
...
-(void)setLastPoint:(SCD_Struct_UI83)arg1 ;
-(SCD_Struct_UI83)lastPoint;
-(id)emissionHandler;
