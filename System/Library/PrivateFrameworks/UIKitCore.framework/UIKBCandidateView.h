...
@interface UIKBCandidateView : UIKBKeyView {
	...
	SCD_Struct_UI79 _visualStyling;
	UIView* _candidateKey;

}

@property (assign,nonatomic) SCD_Struct_UI79 visualStyling;              //@synthesize visualStyling=_visualStyling - In the implementation block
...
-(SCD_Struct_UI79)visualStyling;
-(id)candidateList;
-(UIView *)candidateKey;
-(void)setVisualStyling:(SCD_Struct_UI79)arg1 ;
-(BOOL)isTenKey;
