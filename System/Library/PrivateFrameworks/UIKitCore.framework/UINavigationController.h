...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
	...
	SCD_Struct_UI44 _interactiveScrollNavBarIntrinsicHeightRange;
...
-(void)_getRotationContentSettings:(SCD_Struct_UI43*)arg1 ;
...
-(double)_navigationBar:(id)arg1 preferredHeightForTransitionToHeightRange:(SCD_Struct_UI44)arg2 ;
...
-(SCD_Struct_UI45)_calculateTopLayoutInfoForViewController:(id)arg1 ;
...
-(SCD_Struct_UI44)_intrinsicNavigationBarHeightRangeForNavItem:(id)arg1 ;
...
-(SCD_Struct_UI44)_heightRangeOfTopViews;
