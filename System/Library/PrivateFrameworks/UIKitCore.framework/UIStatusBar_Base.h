...
@interface UIStatusBar_Base : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI108* _localDataOverrides;
...
@property (nonatomic,readonly) SCD_Struct_UI108* localDataOverrides;                                                //@synthesize localDataOverrides=_localDataOverrides - In the implementation block
...
-(int)styleOverrides;
-(void)statusBarServer:(id)arg1 didReceiveStatusBarData:(const SCD_Struct_UI105*)arg2 withActions:(int)arg3 ;
...
-(void)forceUpdateToData:(const SCD_Struct_UI105*)arg1 animated:(BOOL)arg2 ;
...
-(SCD_Struct_UI108*)localDataOverrides;
...
-(void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const SCD_Struct_UI105*)arg2 withActions:(int)arg3 ;
-(BOOL)_isTransparent;
...
-(void)setLocalDataOverrides:(SCD_Struct_UI108*)arg1 ;
