...
@interface UIStatusBar : UIStatusBar_Base <UIStatusBarServerClient> {
	...
	SCD_Struct_UI105 _currentRawData;
...
+(void)getData:(SCD_Struct_UI105*)arg1 forRequestedData:(const SCD_Struct_UI105*)arg2 withOverrides:(const SCD_Struct_UI108*)arg3 ;
