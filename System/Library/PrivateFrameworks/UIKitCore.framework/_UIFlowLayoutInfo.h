...
@interface _UIFlowLayoutInfo : NSObject {
	...
	SCD_Struct_UI36 _rowAlignmentOptions;
	CGSize _contentSize;
...
@property (assign,nonatomic) SCD_Struct_UI36 rowAlignmentOptions;                     //@synthesize rowAlignmentOptions=_rowAlignmentOptions - In the implementation block
...
-(BOOL)horizontal;
-(SCD_Struct_UI36)rowAlignmentOptions;
...
-(id)addSection;
-(void)setRowAlignmentOptions:(SCD_Struct_UI36)arg1 ;
-(BOOL)leftToRight;
