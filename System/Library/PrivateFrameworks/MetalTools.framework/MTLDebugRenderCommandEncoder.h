...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT63 _vertexBuffers[36];
	SCD_Struct_MT63 _vertexTextures[128];
	SCD_Struct_MT63 _vertexSamplers[16];
	SCD_Struct_MT63 _fragmentBuffers[31];
	SCD_Struct_MT63 _fragmentTextures[128];
	SCD_Struct_MT63 _fragmentSamplers[16];
	SCD_Struct_MT63 _tileBuffers[31];
	SCD_Struct_MT63 _tileTextures[128];
	SCD_Struct_MT63 _tileSamplers[16];
	SCD_Struct_MT63 _threadgroupMemoryArguments[31];
	SCD_Struct_MT183 _limits;
	...
	SCD_Struct_MT63 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT182 scissorRect; 
...
@property (nonatomic,readonly) SCD_Struct_MT63 tessellationFactorBufferArgument;                       //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(void)dispatchThreadsPerTile:(SCD_Struct_MT64)arg1 ;
...
-(void)setScissorRect:(SCD_Struct_MT182)arg1 ;
...
-(void)setScissorRects:(const SCD_Struct_MT182*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_MT63)tessellationFactorBufferArgument;
