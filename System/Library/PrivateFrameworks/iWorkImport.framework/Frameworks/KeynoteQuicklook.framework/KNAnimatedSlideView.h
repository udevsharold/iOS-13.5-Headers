...
#import <libobjc.A.dylib/TSDLiveTexturedRectangleSource.h>

@protocol OS_os_log;
@class NSMutableSet, NSMapTable, NSMutableArray, NSObject, TSDCanvas, NSIndexSet, KNAnimatedSlideModel, KNPlaybackSession, KNSlide, KNSlideNode, KNAnimationDelayedCallbacks, NSArray, NSLock, NSSet, NSString;
...
@property (readonly) NSArray * movieControllers;                                            //@synthesize movieControllers=_movieControllers - In the implementation block
