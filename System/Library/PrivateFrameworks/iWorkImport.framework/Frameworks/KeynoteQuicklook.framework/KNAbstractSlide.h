...
@class KNSlideBackgroundInfo, NSOrderedSet, NSMapTable, TSUPointerKeyDictionary, TSUMutablePointerSet, KNSlideStyle, KNTransition, KNTitlePlaceholderInfo, KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideNumberPlaceholderInfo, KNSlideNode, NSDictionary, NSSet, NSArray, TSDFill, NSString, TSDInfoGeometry;
