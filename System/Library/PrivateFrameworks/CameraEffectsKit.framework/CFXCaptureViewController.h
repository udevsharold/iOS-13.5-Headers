...
#import <libobjc.A.dylib/CFXAnimojiTrackingLossDelegate.h>
...
@interface CFXCaptureViewController : UIViewController <CFXEffectEditorViewDelegate, CFXFullScreenTextEditViewControllerDelegate, JTPassThroughContainerViewDelegate, CAMControlVisibilityUpdateDelegate, CAMZoomControlDelegate, CAMZoomSliderDelegate, CFXAnimojiTrackingLossDelegate, CAMDynamicShutterControlDelegate, CAMControlStatusBarDelegate, CFXLiveCaptureViewControllerDelegate, CFXCameraControlsViewControllerDelegate> {
	...
	SCD_Struct_CF26 _dynamicShutterSettings;
...
@property (assign,nonatomic) SCD_Struct_CF26 dynamicShutterSettings;                                                                    //@synthesize dynamicShutterSettings=_dynamicShutterSettings - In the implementation block
...
@property (nonatomic,retain) JTThreadSafeArray * runOnceAnimatedOverlays;                                                               //@synthesize runOnceAnimatedOverlays=_runOnceAnimatedOverlays - In the implementation block
...
-(void)setDynamicShutterSettings:(SCD_Struct_CF26)arg1 ;
...
-(SCD_Struct_CF26)dynamicShutterSettings;
