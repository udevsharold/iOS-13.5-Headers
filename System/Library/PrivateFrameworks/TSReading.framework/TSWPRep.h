...
-(SCD_Struct_TS116)lineMetricsAtPoint:(CGPoint)arg1 ;
...
-(SCD_Struct_TS116)lineMetricsAtCharIndex:(unsigned long long)arg1 ;
...
-(SCD_Struct_TS136)wordMetricsAtCharIndex:(unsigned long long)arg1 ;
