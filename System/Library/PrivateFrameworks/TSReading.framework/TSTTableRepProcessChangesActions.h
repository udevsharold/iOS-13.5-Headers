...
@property (assign,nonatomic) SCD_Struct_TS142 dirtyCellRange; 
@property (assign,nonatomic) SCD_Struct_TS142 dirtyStrokeRange; 
...
-(void)setDirtyCellRange:(SCD_Struct_TS142)arg1 ;
-(void)setDirtyStrokeRange:(SCD_Struct_TS142)arg1 ;
-(SCD_Struct_TS142)dirtyCellRange;
-(SCD_Struct_TS142)dirtyStrokeRange;
