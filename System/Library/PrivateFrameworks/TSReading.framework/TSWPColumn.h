...
-(SCD_Struct_TS116)lineMetricsAtCharIndex:(unsigned long long)arg1 allowEndOfLine:(BOOL)arg2 ;
...
-(SCD_Struct_TS109)heightInfoOfLineFragmentAtIndex:(unsigned long long)arg1 ;
