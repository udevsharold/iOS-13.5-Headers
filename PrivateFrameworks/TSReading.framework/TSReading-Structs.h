...
typedef struct {
	...
	SCD_Struct_TS123 parData;
	SCD_Struct_TS123 parStartData;
	SCD_Struct_TS123 parBidiData;
} SCD_Struct_TS124;
...
typedef struct {
	...
	SCD_Struct_TS122 field6;
	SCD_Struct_TS122 field7;
	SCD_Struct_TS122) field8;
} SCD_Struct_TS129;
...
typedef struct {
	SCD_Struct_TS140 origin;
	SCD_Struct_TS122 size;
} SCD_Struct_TS141;

typedef struct {
	SCD_Struct_TS122 field1;
	SCD_Struct_TS140 field2;
} SCD_Struct_TS142;
...
typedef struct {
	int mFormatType;
	/*function pointer*/void* ;
	SCD_Struct_TS147 mNumberFormatStruct;
	SCD_Struct_TS148 mFractionFormatStruct;
	SCD_Struct_TS149 mBaseFormatStruct;
	SCD_Struct_TS150 mDateFormatStruct;
	SCD_Struct_TS151 mDurationFormatStruct;
	SCD_Struct_TS154 mCustomFormatStruct;
	SCD_Struct_TS152 mControlFormatStruct;
	SCD_Struct_TS153) mMultipleChoiceListFormatStruct;
} SCD_Struct_TS155;
...
typedef struct {
	...
	= field3;
	SCD_Struct_TS148 field4;
	SCD_Struct_TS149 field5;
	SCD_Struct_TS151 field6;
	SCD_Struct_TS152 field7;
	SCD_Struct_TS154 field8;
	SCD_Struct_TS156 field9;
	SCD_Struct_TS157 field10;
	SCD_Struct_TS158) field11;
} SCD_Struct_TS159;
...
typedef struct {
	...
	SCD_Struct_TS155 mCurrentCellFormat;
...
typedef struct {
	...
	id mCommentStorage;
	 TSDCommentStorage;
	SCD_Struct_TS172 mCellFormats;
	unsigned char mStrokePresetNumber;
} SCD_Struct_TS173;

typedef struct {
	SCD_Struct_TS140 field1;
	SCD_Struct_TS140 field2;
	id field3;
	TSTCellStorage field4;
	SCD_Struct_TS141 field5;
	BOOL field6;
	BOOL field7;
	BOOL field8;
	BOOL field9;
...
typedef struct {
	SCD_Struct_TS175 topLeft;
	SCD_Struct_TS175 bottomRight;
} SCD_Struct_TS176;
